        ...
        >
            <template v-for="item in routerList">
                <template v-if="item.childPermissions">
                    <el-submenu :index="item.menuUrl" :key="item.id">
                        <template slot="title">
                            <i :class="item.icon"></i>
                        ...
                        <template v-for="subItem in item.childPermissions">
                            <el-submenu
                                v-if="subItem.childPermissions"
                                :index="subItem.menuUrl"
                                :key="subItem.id"
                            >
                                <template slot="title">{{ subItem.menuName }}</template>
                                <el-menu-item
                                    v-for="(threeItem,i) in subItem.childPermissions"
                                    :key="i"
...
export default {
    ...
    created() {
        ...
        this.routerList = router.routerList;
    }
};
</script>
